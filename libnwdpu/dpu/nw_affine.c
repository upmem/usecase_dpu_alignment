...
uint32_t init_adn1()
{
  ...
  align_data[align_id].adn1 = get_adn_reader(
      &adn_reader_buffer1,
  ...
  adn_reader *s1 = &align_data[align_id].adn1;
...
uint32_t init_adn2()
{
  ...
  align_data[align_id].adn2 = get_adn_reader(
      &adn_reader_buffer2,
      &sequences[metadata.indexes[align_data[align_id].s2]],
      align_id);

  adn_reader *s2 = &align_data[align_id].adn2;
